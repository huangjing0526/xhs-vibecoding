...
export const PRODUCT_HERO_TEMPLATES: ImageFactoryTemplate[] = [
  ...
  },
  {
    ...
    thumb: "hanger-shot",
    slots: [
      { id: "garment", label: "服装图", description: "平铺或上身的服装照，尽量无遮挡", required: true },
    ],
    scenePresets: [
      { id: "seamless-white", label: "纯白无缝", prompt: "纯白无缝背景，柔和均匀的棚拍光，几乎没有阴影。" },
      { id: "warm-beige", label: "米色墙面", prompt: "米色墙面前，暖调侧光打出浅淡的自然投影。" },
      { id: "wood-rack", label: "原木衣杆", prompt: "原木衣杆上挂拍，背景是浅色墙面，自然光柔和。" },
      { id: "store-rack", label: "店内衣架墙", prompt: "服装店内的金属衣架上，背景是虚化的同色系服装，暖色射灯。" },
      { id: "window-light", label: "窗边自然光", prompt: "室内窗边挂拍，自然光从侧面进来，墙面干净，光影通透。" },
      { id: "grey-studio", label: "浅灰棚拍", prompt: "浅灰色背景纸的摄影棚，均匀柔光，突出面料质感。" },
    ],
    builtIn: true,
  },
];
