        ...
        {WORKFLOW_MODULES.map((module) => {
          ...
          return (
            <button
              ...
              className={`group flex flex-col rounded-xl border bg-white p-3 text-left transition-all hover:-translate-y-0.5 hover:shadow-[0_12px_32px_rgba(0,0,0,0.08)] ${
